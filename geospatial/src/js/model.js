        ...
        [
            {
                name: 'Domain',
                elements: [
                    {text: "Geospatial", category: "domain"},
                    {text: "Trajectories", category: "domain" }
                ]
            },
            {
                name: 'SubDomain',
                property: 'subDomain',
                elements: [
                    {text: "Urban", category: "subDomain"},
                    {text: "Media Analysis", category: "subDomain" },
                    {text: "Oceanography", category: "subDomain"},
                    {text: "Business", category: "subDomain"},
                    {text: "Climate", category: "subDomain"},
                    {text: "Surveillance", category: "subDomain"},
                    {text: "Environmental Analysis", category: "subDomain"},
