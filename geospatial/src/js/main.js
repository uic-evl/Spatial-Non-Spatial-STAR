...
(function() {
    ...
    var geospatial_spreadsheet_url = 'https://docs.google.com/spreadsheets/d/10mhjk1rem8QPK8QGE7BzYu38xPv0t2kxKM_4DM6QBq0/pubhtml';
    ...
    App.initDB = function() {
        ...
        Tabletop.init({
            key: geospatial_spreadsheet_url,
            callback: setupDB,
    ...
    function setupCharts(data){
        ...
        /** initialize a new bubble graph **/
        App.geoGraph = new Graph({
            colorMap: {
                "Urban": "#beaed4",
                "Media Analysis": "#fdc086",
                "Oceanography": "#7fc97f",
                "Business": "#7fc97f",
                "Climate": "#7fc97f",
                "Surveillance": "#7fc97f",
                "Environmental Analysis": "#7fc97f",
                "Cartography": "#7fc97f"
            },
        ...
        App.geoGraph.graphEncodingBubbleNVD3Chart(encodingData.encodings, "#encodings",
            encodingData.subDomainCount, encodingData.authors,
            encodingData.xLabelMap, encodingData.yLabelMap);

        //App.geoGraph.graphEncodingBubbleNVD3Chart(testParsing.pairings, "#encodings",
        //    testParsing.max, testParsing.xDomain, testParsing.authors, testParsing.subDomains);

        // plot the task analysis
        App.geoGraph.graphTaskBarNVD3Chart(taskData.tasks, "#tasks", taskData.authors[0]);

        // plot the data type analysis
        App.geoGraph.graphTypeBarNVD3Chart(taskData.dataTypes, "#dataTypes", taskData.authors[1]);

        // // plot the data type analysis
        App.geoGraph.graphEvaluationNVD3Chart(taskData.evaluation, "#evaluation", taskData.authors[2]);
